...
public class RestExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorObject> handlerFieldEmptyException(FieldEmptyException e){
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorObject> handlerNoDataFoundException(NoDataFoundException e){
        ErrorObject errorObject= new ErrorObject();
        errorObject.setMessage(e.getMessage());
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorObject> handlerRescourceNotFoundException(RescourceNotFoundException e){
        ErrorObject errorObject= new ErrorObject();
        errorObject.setMessage(e.getMessage());
